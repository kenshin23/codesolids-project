...
public class Academia extends Panel {
	...
	private void constructorComp() {
		...
		tituloSuperior.setText("ACADEMIA");
		...
		ResourceImageReference ir = new ResourceImageReference("/MapaJuego/Codesolids/mago_fuego5.jpg");
		...
		//returnButton.setForeground(new Color(0xd4630c));
		//returnButton.setRolloverForeground(new Color(0xb81833));	
		//returnButton.setRolloverFont(new Font(new Font.Typeface("ARIAL"), Font.ITALIC | Font.BOLD, new Extent(16, Extent.PT)));
		//returnButton.setFont(new Font(new Font.Typeface("ARIAL"), Font.ITALIC| Font.BOLD, new Extent(13, Extent.PT))):
	...
	}//el actionlistener fue tomado de los tutoriales del profesor
}
