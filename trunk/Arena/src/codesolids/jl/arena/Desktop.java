...
public class Desktop extends ContentPane {
	...
	private Poder poder,poder2,poder1Pc,poder2Pc;
	...
	private CapacityBar barraVida1, barraAux;
	...
	private Component initArena(){
		...
		colEstado.setInsets(new Insets(5,5,5,50));
	...
	public Component crearBarraVida1(){

		barraVida1 = new CapacityBar(10, 150); 
		barraVida1.setShowTicks(false);
		barraVida1.setReflectivity(0.1);
		List<Color> listColor = new ArrayList<Color>();
		listColor.add(Color.RED);
		listColor.add(Color.WHITE);
		barraVida1.setColors(listColor);
	...
	public Component crearBarraVida2(){	

		barraVida2 = new CapacityBar(10, 150); 
		barraVida2.setShowTicks(false);
		barraVida2.setReflectivity(0.1);
		List<Color> listColor = new ArrayList<Color>();
		listColor.add(Color.RED);
		listColor.add(Color.WHITE);
		barraVida2.setColors(listColor);
		listNumber = new ArrayList<Number>();
		listNumber.add(1000); 
		listNumber.add(0); 
	...
	public Component crearBarraPsinergia(){	

		barraPsinergia = new CapacityBar(10, 150); 
		barraPsinergia.setShowTicks(false);
		barraPsinergia.setReflectivity(0.1);
		List<Color> listColor = new ArrayList<Color>();
		listColor.add(Color.BLUE);
		listColor.add(Color.WHITE);
		barraPsinergia.setColors(listColor);
		listNumber = new ArrayList<Number>();
		listNumber.add(p1.getCp()); 
		listNumber.add(0); 
		barraPsinergia.setValues(listNumber);

		return barraPsinergia;
	}
	...
	private Component CrearCapacityXp() {

		CapacityBar barraXp = new CapacityBar(10, 150); 
		barraXp.setShowTicks(false);
		barraXp.setReflectivity(0.1);
		List<Color> listColor = new ArrayList<Color>();
		listColor.add(Color.GREEN);
		listColor.add(Color.WHITE);
		barraXp.setColors(listColor);
		listNumber = new ArrayList<Number>();
		listNumber.add(p1.getXp());
		listNumber.add(200); 
	...
	private Row CreateButtonSpecial()
	{
		...
		btnAttack1.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnAttack2.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnAttack3.setToolTipText("Damage: " + listPoder.get(1).getDamage() + //
				"\nCooldown: " + listPoder.get(1).getCooldown() +// 
				"\nPsinergia: " + listPoder.get(1).getPsinergia());
		btnAttack3.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnAttack4.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnAttack5.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnAttack6.setStyle(GUIStyles.DEFAULT_STYLE);
	...
	private Row CreateButtonBasic()
	{
		...
		btnHit.setStyle(GUIStyles.DEFAULT_STYLE);
		...
		btnLoadCp.setStyle(GUIStyles.DEFAULT_STYLE);
