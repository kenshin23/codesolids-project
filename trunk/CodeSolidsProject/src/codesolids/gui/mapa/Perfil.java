...
public class Perfil extends ContentPane {
	...
	private void constructorComp() {
		...
		ResourceImageReference ir = new ResourceImageReference("/images/Mapa/guerrera.jpg");
		...
		private void regresarBtnClicked(ActionEvent e) {
