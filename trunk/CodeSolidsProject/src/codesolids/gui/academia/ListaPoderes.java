...
public class ListaPoderes {
	...
	public ListaPoderes(int level,String nombre,int oro,int dano,int tiempoReutilizacion,int psinergia,String tipo,boolean uso,String dirImage)
	{
		this.level = level;
		this.nombre = nombre;
		this.oro = oro;
