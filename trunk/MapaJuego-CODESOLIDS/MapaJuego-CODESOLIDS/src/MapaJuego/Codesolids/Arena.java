...
public class Arena extends Panel {
	...
	private void constructorComp() {
		...
		ResourceImageReference ir = new ResourceImageReference("/MapaJuego/Codesolids/mago_mujer_tierra.jpg");
